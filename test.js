export default {
  mode: 'production',
  context: 'D:\\2019-transport\\fleet_fe_pc',
  devtool: false,
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: 'D:\\2019-transport\\fleet_fe_pc\\production',
  ...
  resolve: {
    alias: {
      '@': 'D:\\2019-transport\\fleet_fe_pc\\src',
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'D:\\2019-transport\\fleet_fe_pc\\node_modules\\cache-loader\\dist\\cjs.js',
            options: {
              cacheDirectory: 'D:\\2019-transport\\fleet_fe_pc\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '00851020'
            }
          },
      ...
      /* config.module.rule('svg') */
      {
        test: /\.(svg)(\?.*)?$/,
        exclude: [
          'D:\\2019-transport\\fleet_fe_pc\\src\\icons'
        ],
        use: [
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          NODE_ENV: '"production"',
          VUE_APP_BAIDU_MAP_AK: '"76QLuGz9RIEHRLrGjY0Ol0uIgetkKvNU"',
          VUE_APP_CLI_UI_URL: '""',
          VUE_APP_DRIVER_URI: '"http://driver.mayibida.net"',
          VUE_APP_GOOGLE_ANALYTICS: '"UA-131189285-1"',
          VUE_APP_MOS_URI: '"https://mayibida.net:20006"',
          VUE_APP_VERSON: '"3.2"',
          BASE_URL: '"/"'
        }
      }
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'D:\\2019-transport\\fleet_fe_pc\\public\\index.html',
        cdn: {
          externals: {
            vue: 'Vue',
    ...
    new CopyPlugin(
      [
        {
          from: 'D:\\2019-transport\\fleet_fe_pc\\public',
          to: 'D:\\2019-transport\\fleet_fe_pc\\production',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
